...
module.exports = {
    getAll: async (req, res) => {
        try {
            const ChoNghis = await ChoNghiModel.find().populate("TienNghi").populate("Phong").populate("TinDung").populate("Phong.LoaiPhong").exec();
    ...
    get: async (req, res) => {
        try {
            ...
            const ChoNghi = await ChoNghiModel.findOne({ _id: MaChoNghi }).populate("TienNghi").populate("Phong").populate("TinDung").exec();
