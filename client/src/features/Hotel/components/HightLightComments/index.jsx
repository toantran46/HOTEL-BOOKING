        ...
        <div className='hight-light-comments'>
            <div className='hight-light-comments__header'>
                <div className='hight-light-comments__header__avatar'>
                    {
                        feedBack?.MaKH.Avatar ? <img src={feedBack?.MaKH?.Avatar} alt='avatar' width="100%" height="100%" /> : feedBack?.MaKH.name?.charAt(0)?.toUpperCase()
                    }

                </div>
                <div className='hight-light-comments__header__info'>
                    <div className='hight-light-comments__header__info__name'>{feedBack?.MaKH?.name}</div>
