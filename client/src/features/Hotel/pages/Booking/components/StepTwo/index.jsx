    ...
    return (
        <div className='step-two'>
            <div className="step-two__box">
                <h5>Mách nhỏ: </h5>
                <div className='tips'>
                    <CheckCircleOutlined style={{ marginRight: 10, color: "#008009" }} /> Miễn phí hủy đến 23:59 ngày 5 tháng 4, 2022
                </div>
                <div className='tips'>
            ...
            <div className="step-two__box green-bg">
                ...
                <Row gutter={[30, 0]}>
                    <Col>
                        <InputField label='Họ (tiếng Anh) *' name='surName' />
                    </Col>
                    <Col>
                        <InputField label='Tên (tiếng Anh) *' name='name' />
                    </Col>
                </Row>
                <InputField label='Địa chỉ email *' name='email' type='email' placeholder='chú ý tránh lỗi chính tả' />
                <div className='more-info-blur'>Email xác nhận đặt phòng sẽ được gửi đến địa chỉ này</div>

                <InputField label='Xác nhận địa chỉ email *' name='email' type='email' />

            </div>

            <div className="step-two__box green-bg">
                <h5>Phòng Superior 2 giường đơn nhìn ra cảnh thành phố</h5>
                <div className='tips'>
                    <CheckCircleOutlined style={{ marginRight: 10, color: "#008009" }} /> <span>Miễn phí hủy</span> đến 23:59 ngày 5 tháng 4, 2022
                </div>
                <div className='more-info-blur' style={{ marginTop: 5 }}> <MdSmokeFree />  Không hút thuốc</div>

                <div className='convenients'>
                    <FavouriteConvenients convenients={convenients} />
                </div>

                <div className='max-num'>Số người tối đa: {ICONS.PERSON} {ICONS.PERSON}{ICONS.PERSON} </div>
                <InputField label='Tên đầy đủ của khách' name='email' placeholder='Họ (tiếng Anh), Tên (tiếng Anh)' />
            </div>
            ...
            <div className="step-two__box green-bg">
                ...
                <br />
                <InputField label='Vui lòng ghi yêu cầu của bạn tại đây. (không bắt buộc)' name='' type='textarea' />
            </div>

            <div className="step-two__box green-bg">
                <h5>Thời gian đến của bạn</h5>
                <div className='tips mb-2' >
                    <CheckCircleOutlined style={{ fontSize: 18, marginRight: 15, color: "#008009" }} /> Phòng của bạn sẽ sẵn sàng để nhận vào lúc 15:00
                </div>
                <div className='tips'>
                ...
                <Select style={{ minWidth: "50%" }} defaultValue={-2} >
                    <Select.Option disabled value={-2}>Vui lòng chọn</Select.Option>
                    <Select.Option value={-1}>Tôi không biết</Select.Option>
                    <Select.Option value={1}>00:00-01:00</Select.Option>
                    <Select.Option value={2}>01:00-02:00</Select.Option>
                    <Select.Option value={3}>02:00-03:00</Select.Option>
                </Select>
            </div>
            <div style={{ textAlign: 'end' }}>
                <Button type='primary'>Tiếp theo: Chi tiết cuối cùng <RightOutlined /></Button>
            </div>
        </div>
    );
}
