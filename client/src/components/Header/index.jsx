            ...
            <div className='header'>
                <div className='header__top'>
                    ...
                    <div className='header__top__right'>
                        ...
                        <a className='header__top__right__btn-outline'>Đăng chổ nghỉ của Quý vị</a>
                        <a className='header__top__right__btn-fullfill'>Đăng ký</a>
                        <a className='header__top__right__btn-fullfill'>Đăng nhập</a>
                    </div>
                </div>
